...
| **Promoter records, link in bio and fan referrals live** | Code is done | Migrations `20260924215000`, `223000`, `230000`, `233000`, `234500`, then `20260925000000` and `20260925001000`, applied in that order (each is safe to re-run) |
