...
| **Fan referral rewards** ("bring 3 friends, get in free") | Fan shares are already tagged; the reward is a product call | A decision on the reward (comp, discount, perk) |
...
| **Promoter records live** | Code is done | Migrations `215000`, `223000`, `230000` and `233000` applied |
