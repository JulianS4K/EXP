...
export const en = {
  ...
  'event.onSaleSoon': 'On sale soon',
  'event.onSaleSoonHint': 'Paid tickets for this event aren\'t on sale yet. Tap Save below and we\'ll let you know when they are.',
  'event.tierSoldOut': 'Sold out · join the waitlist',
  'event.left': '{n} left',
  'event.pickTicket': 'Pick a ticket',
  'event.from': 'From',
  ...
  'event.comingSoon': 'Paid tickets go on sale soon.',
  ...
  'tickets.vaultHint': 'Sign in to see your tickets',
  'tickets.syncing': '// syncing tickets...',
  'tickets.kicker': 'Your tickets',
  ...
  'ticket.level': 'ticket type',
  'ticket.passNo': 'pass',
  'ticket.textIt': 'Text it',
  'ticket.igStory': 'Instagram story',
  ...
  'claim.conflict': 'SENT TO A DIFFERENT EMAIL',
...
export const es: Record<DictKey, string> = {
  ...
  'event.onSaleSoon': 'Pronto a la venta',
  'event.onSaleSoonHint': 'Las entradas de pago aún no están a la venta. Toca Guardar abajo y te avisaremos cuando lo estén.',
  'event.tierSoldOut': 'Agotado · únete a la lista de espera',
  'event.left': 'Quedan {n}',
  'event.pickTicket': 'Elige tu entrada',
  'event.from': 'Desde',
  'event.getTickets': 'Conseguir entradas',
  'event.joinWaitlist': 'Lista de espera',
  'event.soldOut': 'Agotado',
  'event.processing': 'Procesando…',
  'event.available': 'Disponible',
  'event.free': 'Gratis',
  'event.comingSoonTitle': 'Próximamente',
  'event.comingSoon': 'Las entradas de pago salen a la venta pronto.',
  ...
  'tickets.vaultHint': 'Inicia sesión para ver tus entradas',
  'tickets.syncing': '// sincronizando entradas...',
  'tickets.kicker': 'Tus entradas',
  ...
  'ticket.level': 'tipo de entrada',
  'ticket.passNo': 'pase',
  'ticket.textIt': 'Enviar por SMS',
  'ticket.igStory': 'Historia de Instagram',
  ...
  'claim.conflict': 'ENVIADA A OTRO CORREO',
